...
class myofilaments():
    ...
    def __init__(self, myofil_params, parent_half_sarcomere):
        ...
        self.filament_compliance_factor = float(myofil_params["filament_compliance_factor"][0])
        ...
        self.x = np.arange(self.bin_min, self.bin_max+self.bin_width,self.bin_width)
        self.no_of_x_bins = np.size(self.x)
        self.thick_filament_length = float(myofil_params["thick_filament_length"][0])
        self.thin_filament_length = float(myofil_params["thin_filament_length"][0])
        ...
        self.passive_mode = myofil_params["passive_mode"][0]
