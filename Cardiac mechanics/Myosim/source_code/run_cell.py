...
#------------------------------------------------------------------------------
    cell_state = hs_params["myofilament_parameters"]["cell_state"][0]
...
#-------------------------------------------------------------------------------
    ...
    if cell_state == "normal":
        file_path = "/home/fenics/shared/Myosim/source_code/parameter_file/single-cell/Normal-Cell.dat"
    elif cell_state == "ischemia-1a":
        file_path = "/home/fenics/shared/Myosim/source_code/parameter_file/single-cell/IschemiaCell-1a.dat"
    elif cell_state == "ischemia-1b":
        file_path = "/home/fenics/shared/Myosim/source_code/parameter_file/single-cell/IschemiaCell-1b.dat"
    elif cell_state == "MI-short":
        file_path = "/home/fenics/shared/Myosim/source_code/parameter_file/single-cell/MI-short.dat"
    elif cell_state == "MI-long":
        file_path = "/home/fenics/shared/Myosim/source_code/parameter_file/single-cell/MI-long.dat"

    with open(file_path, "r") as f:
        for i in range(1000):
            item = f.readline().split('\t')[1:-1]
            VoltList.append(list(map(float, item))[0])
            CaList.append(list(map(float, item))[1])
